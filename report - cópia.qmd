...
From the p-value of this ANOVA test we gather that the additional predictors in the transformed model provide an improvement over the best subsets model. This is also validated by the better RMSE score we obtained from the original transformed model we can see below.
