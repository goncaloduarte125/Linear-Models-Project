...
print(paste("RMSE:", round(rmse_score, 4)))
```
...
print(paste("RMSPE Stepwise:", round(rmse_score, 4)))
...
# Predictions 
pred_sq_final <- predict(mod_step, newdata = predict_data)
pred_final_real <- sqrt(pmax(0, pred_sq_final)) - 0.1


predictions <- data.frame(
  Structure_id = predict_data$Structure_id,
  Condition = pred_final_real
)
...
model_poisson <- glm(Condition ~ . - Structure_id, family = poisson, data = db_train)
